...
const CookiePolicyContent = () => {
  return (
    <article className="cookie-policy-content container">
      <h2>Cookies Policy</h2>

      <p>Last updated: November 04, 2019</p>

      <p>
        Fast Sale Property Solutions ("us", "we", or "our") uses cookies on the
        https://fastsalepropertysolutions.co.uk/ website (the "Service"). By
      ...
      <h2>How Fast Sale Property Solutions uses cookies</h2>
