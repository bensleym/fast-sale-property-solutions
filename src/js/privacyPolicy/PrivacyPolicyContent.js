...
const PrivacyPolicyContent = () => {
  return (
    <article className="privacy-policy-content container">
      <h2>Privacy Policy</h2>

      <p>Effective date: November 04, 2019</p>

      <p>
        Fast Sale Property Solutions ("us", "we", or "our") operates the
        https://fastsalepropertysolutions.co.uk/ website (hereinafter referred
        to as the "Service").
      </p>
      ...
      <p>
        ...
        https://fastsalepropertysolutions.co.uk/
      </p>
      ...
      <ul>
        <li>
          ...
          <p>
            Service is the https://fastsalepropertysolutions.co.uk/ website
            operated by Fast Sale Property Solutions
          </p>
        </li>
        <li>
          <p>
      ...
      <h2>Use of Data</h2>
      <p>
        Fast Sale Property Solutions uses the collected data for various
        purposes:
      </p>
      <ul>
      ...
      <p>
        If you are from the European Economic Area (EEA), Fast Sale Property
        Solutions legal basis for collecting and using the personal information
        described in this Privacy Policy depends on the Personal Data we collect
        and the specific context in which we collect it.
      </p>
      <p>
        Fast Sale Property Solutions may process your Personal Data because:
      </p>
      <ul>
      ...
      <p>
        Fast Sale Property Solutions will retain your Personal Data only for as
      ...
      <p>
        Fast Sale Property Solutions will also retain Usage Data for internal
      ...
      <p>
        Fast Sale Property Solutions will take all the steps reasonably
      ...
      <p>
        Fast Sale Property Solutions may disclose your Personal Data in the good
        faith belief that such action is necessary to:
      </p>
      <ul>
        <li>To comply with a legal obligation</li>
        <li>
          To protect and defend the rights or property of Fast Sale Property
          Solutions
        </li>
        <li>
      ...
      <p>
        ...
        certain data protection rights. Fast Sale Property Solutions aims to
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            right to withdraw your consent at any time where Fast Sale Property
            Solutions relied on your consent to process your personal
            information.
          </p>
        </li>
      </ul>
      ...
      <ul>
        <li>
          ...
          <Link to="/contact-us">
            https://www.fastsalepropertysolutions.co.uk/contact-us
          </Link>
        </li>

        <li>By phone number: 07753 686 480</li>
      </ul>
    </article>
  );
};
