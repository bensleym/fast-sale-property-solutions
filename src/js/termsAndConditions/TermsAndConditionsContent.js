...
const TermsAndConditionsContent = () => {
  return (
    <article className="terms-and-conditions-content container">
      <h1>Terms and Conditions</h1>

      <p>Last updated: November 04, 2019</p>

      <p>
        Please read these Terms and Conditions ("Terms", "Terms and Conditions")
        carefully before using the https://fastsalepropertysolutions.co.uk/
        website (the "Service") operated by Fast Sale Property Solutions ("us",
        "we", or "our").
      </p>
      ...
      <p>
        ...
        will remain the exclusive property of Fast Sale Property Solutions and
        ...
        product or service without the prior written consent of Fast Sale
        Property Solutions.
      </p>
      ...
      <p>
        ...
        are not owned or controlled by Fast Sale Property Solutions.
      </p>

      <p>
        Fast Sale Property Solutions has no control over, and assumes no
        responsibility for, the content, privacy policies, or practices of any
        third party web sites or services. You further acknowledge and agree
        that Fast Sale Property Solutions shall not be responsible or liable,
      ...
      <p>
        You agree to defend, indemnify and hold harmless Fast Sale Property
        Solutions and its licensee and licensors, and their employees,
      ...
      <p>
        In no event shall Fast Sale Property Solutions, nor its directors,
      ...
      <p>
        Fast Sale Property Solutions its subsidiaries, affiliates, and its
      ...
      <p>
        ...
        other provision of these terms, under no circumstances will Fast Sale
        Property Solutions ever be liable to you or any other person for any
        ...
        limitation gross negligence and fundamental breach) by Fast Sale
        Property Solutions or any person for whom Fast Sale Property Solutions
        is responsible, and even if Fast Sale Property Solutions has been
